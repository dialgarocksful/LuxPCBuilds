<html>
    ...
    <link href="../adjusts.css" rel="stylesheet" type="text/css">
	</head>
		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
			  <ul class="nav navbar-nav">
				...
				<li class="dropdown">
				  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Intel Builds<span class="caret"></span></a>
				  <ul class="dropdown-menu">
					<li><a href="../Intel/gaming.php">Gaming</a></li>
					<li><a href="../Intel/productivity.php">Productivity</a></li>
					<li><a href="../Intel/enthusiast.php">Enthusiast</a></li>
					<li><a href="../Intel/legacy.php">Legacy</a></li>
				  </ul>
				</li>
				...
				<li class="dropdown">
				  ...
				  <ul class="dropdown-menu">
					<li><a href="../AMD/ryzen.php">Ryzen</a></li> 
					<li><a href="../AMD/threadripper.php">Threadripper</a></li>
					<li><a href="../AMD/legacy.php">Legacy</a></li>
				  </ul>
				</li>
